...
Merci de confirmer la disponibilité et les détails de la réservation 🙏
    ...
    toast.success("Réservation envoyée sur WhatsApp !", {
      description: "Vérifiez votre conversation pour finaliser.",
    });
